...
// curl http://localhost:3100/alunos
// a função getAlunos foi mapeada para a URL http://localhost:3100/alunos
app.get("/alunos", bd.getAlunos);
// curl http://localhost:3100/alunos/5
// o parâmetro id será passado na URL da seguinte forma http://localhost:3100/alunos/5
app.get('/alunos/:id', bd.getAlunosById);
// curl -d "nome=Lucas Dias&idade=20" http://localhost:3100/alunos
...
// curl -X PUT -d "nome=Ana Maria&idade=22" http://localhost:3100/alunos/3
// para fazer um update precisamos usar o método PUT
app.put('/alunos/:id', bd.updateAluno);


/* 
para deixar o seu servidor rodando na porta 3100
http://localhost:3100/
*/
app.listen(3100, () => {
